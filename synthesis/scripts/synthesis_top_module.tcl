...
analyze -format verilog { ../../source/fifo_memory.v }
analyze -format verilog { ../../source/gray_code_sync.v }
analyze -format verilog { ../../source/read_control_logic.v }
analyze -format verilog { ../../source/write_control_logic.v }
